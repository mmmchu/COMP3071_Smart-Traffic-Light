...
road_id = os.path.basename(net_file).replace(".net.xml", "")
...
emergency_log_path = os.path.join(result_dir, "emergency_wait_log.csv")
...
with open(summary_path, "w", encoding="utf-8") as f:
    f.write("\U0001F4CA Summary QL Metrics:\n")
